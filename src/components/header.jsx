...
function Header() {
  ...
  return (
    <header className="bg-white header-hai">
      <nav
        aria-label="Global"
        className="mx-auto flex max-w-screen-2xl   items-center justify-stretch py-6 lg:px-0"
      >
        <div className="flex lg:flex-1 ">
          <a href="/" className="-m-1.5 p-1.5 ">
            ...
            <img
              alt=""
              src="https://i.imgur.com/BC9W51a.jpeg"
        ...
        <PopoverGroup className="hidden lg:flex lg:gap-x-12 ">
          <Popover className="relative">
            <PopoverButton className="flex items-center gap-x-1 text-xl font-bold leading-6 text-gray-900  ">
              Example 1
              <ChevronDownIcon
                aria-hidden="true"
              ...
              <div className="grid grid-cols-2 divide-x divide-gray-900/5 bg-gray-50">
                {callsToAction.map((item) => (
                  <a
                    key={item.name}
                    href={item.href}
                    className="flex items-center justify-center gap-x-2.5 p-3 text-xl font-bold leading-6 text-gray-900 hover:bg-gray-100"
                  >
                    <item.icon
                      aria-hidden="true"
                      className="h-5 w-5 flex-none text-gray-400"
                  ...
                  <DisclosurePanel className="mt-2 space-y-2">
                    {[...products, ...callsToAction].map((item) => (
                      <DisclosureButton
                        ...
                        as="a"
                        href={item.href}
                        className="block rounded-lg py-2 pl-6 pr-3 text-xl font-bold leading-7 text-gray-900 hover:bg-gray-50"
                      >
                        {item.name}
                      </DisclosureButton>
                    ))}
